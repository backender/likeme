...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // likemeToplikedBundle_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]+?)$#xs', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'likeme\\ToplikedBundle\\Controller\\DefaultController::indexAction',)), array('_route' => 'likemeToplikedBundle_homepage'));
        }

        // likemeRandomBundle_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]+?)$#xs', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'likeme\\RandomBundle\\Controller\\DefaultController::indexAction',)), array('_route' => 'likemeRandomBundle_homepage'));
        }

        // likemeLikingBundle_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]+?)$#xs', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'likeme\\LikingBundle\\Controller\\DefaultController::indexAction',)), array('_route' => 'likemeLikingBundle_homepage'));
        }

        // likemeMessageBundle_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]+?)$#xs', $pathinfo, $matches)) {
        ...
        // likemeSpamBundle_homepage
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]+?)$#xs', $pathinfo, $matches)) {
            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'likeme\\SpamBundle\\Controller\\DefaultController::indexAction',)), array('_route' => 'likemeSpamBundle_homepage'));
        }

        // _newSpam
        if (rtrim($pathinfo, '/') === '/newSpam') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', '_newSpam');
            }
